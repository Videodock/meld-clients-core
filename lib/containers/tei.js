...
class TEI extends _react.Component {
  constructor(props) {
    super(props);
    this.state = {
      tei: {},
    ...
    if (_prefixes.prefix.oa + "motivatedBy" in annotation) {
      ...
      annotation["oa:hasBody"].map(b => {
        ...
        if (b["@id"] === _meldActions.MARKUP_EMPHASIS) {
          this.props.handleEmphasis(_reactDom.default.findDOMNode(this), annotation, this.props.uri, fragments);
        } else if (b["@id"] === _meldActions.MARKUP_HIGHLIGHT) {
          this.props.handleHighlight(_reactDom.default.findDOMNode(this), annotation, this.props.uri, fragments);
        } else if (b["@id"] === _meldActions.MARKUP_HIGHLIGHT2) {
          this.props.handleHighlight2(_reactDom.default.findDOMNode(this), annotation, this.props.uri, fragments);
        } else if (b["@id"] === _meldActions.CUE_IMAGE) {
          this.props.handleCueImage(_reactDom.default.findDOMNode(this), annotation, this.props.uri, fragments, this.props.tei.fragImages);
        } else {
