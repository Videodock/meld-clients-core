...
class Score extends _react.default.Component {
  constructor(props) {
    super(props);
    this.state = {
      score: {},
  ...
  handleMELDActions(annotation, fragments) {
    ...
    if ("oa:motivatedBy" in annotation) {
      ...
      annotation[_index.HAS_BODY].map(b => {
        // TODO convert to switch statement
        if (b["@id"] === _meldActions.MARKUP_EMPHASIS) {
          this.props.handleEmphasis(_reactDom.default.findDOMNode(this), annotation, this.props.uri, fragments["MEI"]);
        } else if (b["@id"] === _meldActions.MARKUP_HIGHLIGHT) {
          this.props.handleHighlight(_reactDom.default.findDOMNode(this), annotation, this.props.uri, fragments["MEI"]);
        } else if (b["@id"] === _meldActions.MARKUP_HIGHLIGHT2) {
          this.props.handleHighlight2(_reactDom.default.findDOMNode(this), annotation, this.props.uri, fragments["MEI"]);
        } else if (b["@id"] === _meldActions.CUE_AUDIO) {
          this.props.handleCueAudio(_reactDom.default.findDOMNode(this), annotation, b, this.props.uri, fragments);
        } else if (b["@id"] === _meldActions.CUE_VIDEO) {
          this.props.handleCueVideo(_reactDom.default.findDOMNode(this), annotation, b, this.props.uri, fragments);
        } else {
